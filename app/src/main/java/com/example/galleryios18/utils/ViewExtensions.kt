...
fun AppCompatTextView.setTextColorRes(@ColorRes color: Int) {
    this.setTextColor(ContextCompat.getColor(this.context, color))
}

fun AppCompatTextView.setColorResourceTextView(@ColorRes color: Int) {
...
fun View.setOnClickDebounced(interval: Long = 1000, onClick: (View) -> Unit) {
