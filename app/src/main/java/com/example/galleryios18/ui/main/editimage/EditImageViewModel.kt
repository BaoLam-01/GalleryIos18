...
class EditImageViewModel : BaseViewModel() {
    val listItemAdjust: MutableLiveData<List<ItemProgress>> = MutableLiveData()
    ...
    private fun getListItemAdjust(): List<ItemProgress> {
        val listItemProgress = mutableListOf<ItemProgress>()
        listItemProgress.add(
            ItemProgress(
