...
public class HorizontalWheelView extends View {
    ...
    private void readAttrs(AttributeSet attrs) {
        ...
        int cursorColor = a.getColor(R.styleable.HorizontalWheelView_cursorColor, DEFAULT_CURSOR_COLOR);
        drawer.setCursorColor(cursorColor);
    ...
    private String TAG = "HorizontalWheelView";

    private boolean checkEndLock(double radians) {

//        Log.e(TAG, "checkEndLock: " +radians);
//        Log.e(TAG, "2 * PI: " +2 * PI);
//        Log.e(TAG, "checkEndLock 2: " +radians * 4.98);

        // radians = radians * 4.99;
    ...
    public void setDegreesAngle(double degrees) {
        double radians = degrees * PI / 180 * 0.72;
//        Log.e(TAG, "degrees: "+ degrees);
//        Log.e(TAG, "setDegreesAngle: "+ radians);
    ...
    public double getDegreesAngle() {
        return getRadiansAngle() * 180 / PI * 5F;
    }
