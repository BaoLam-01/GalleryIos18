...
abstract class MediaCodecDecoder {
    ...
    private final OnDecoderEventListener mOnDecoderEventListener;
    ...
    public MediaCodecDecoder(MediaExtractor extractor, boolean passive, int trackIndex,
        ...
        mCodec = MediaCodec.createDecoderByType(Objects.requireNonNull(mFormat.getString(MediaFormat.KEY_MIME)));
