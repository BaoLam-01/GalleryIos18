...
import com.filter.utils.LoadShaderManager;
...
public class GPUImageFilter {
    ...
    public static String loadShaderFromAssets(Context context,String file) {
        LoadShaderManager shaderManager = LoadShaderManager.getInstance();
        shaderManager.addShader(file,context);
        return shaderManager.getShader(file);
    }
