...
public class PhotoRiseImageAnimate extends BaseImageAnimate {
...
//        imageView.setScaleY(1.1f);
    ...
    protected void animate() {
        ...
        setPhotoRise(alpha, transY, 1.1f);
    }

    private void setPhotoRise(float alpha, float transY, float scale) {
...
//        capVaImageView.getImageView().setScaleY(scale);
    ...
    public void stopAnimation() {
        super.stopAnimation();
        setPhotoRise(transparentDefault, 0, 1f);
    }
    ...
    public String getName() {
        return ImageAnimate.PHOTO_RISE.name();
    }
}
